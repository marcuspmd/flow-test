...
export class AssertionService {
    // Warning: (ae-forgotten-export) The symbol "Assertions_2" needs to be exported by the entry point index.d.ts
    // Warning: (ae-forgotten-export) The symbol "ExecutionResult" needs to be exported by the entry point index.d.ts
    // Warning: (ae-forgotten-export) The symbol "AssertionResult_2" needs to be exported by the entry point index.d.ts
    validateAssertions(assertions: Assertions_2, result: ExecutionResult): AssertionResult_2[];
}
...
export class CaptureService {
    captureVariables(captureConfig: Record<string, string>, result: ExecutionResult): Record<string, any>;
...
export class HttpService {
    ...
    // Warning: (ae-forgotten-export) The symbol "RequestDetails_2" needs to be exported by the entry point index.d.ts
    executeRequest(stepName: string, request: RequestDetails_2): Promise<ExecutionResult>;
