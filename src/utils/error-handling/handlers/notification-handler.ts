...
export class NotificationErrorHandler extends BaseErrorHandler {
   ...
   */
  private async sendNotification(error: Error, context: ErrorContext): Promise<void> {
   ...
   */
  private formatNotification(error: Error, context: ErrorContext): Record<string, any> {
    return {
